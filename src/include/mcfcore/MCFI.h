...
namespace MCFCore
{
	...
	public:
		...
		//! Downloads and installs files to path with out saving them in the mcf first
		//!
		//! @param szSavePath Path to save files to
		//!
		virtual void downloadAndInstall(const char* szSavePath)=0;
	};
	...
	public:
		...
		MOCK_METHOD1(downloadAndInstall, void(const char* szSavePath));
	};
